            ...
            const info = await transporter.sendMail({
                ...
                html: `<html>
                            <body style="color:#083a08; font-family: Lato, Arial, Helvetica, sans-serif;
                                ...
                                <p style="text-decoration: underline; font-size: 24px;"><a style="color:#6A75AA;font-weight: 600;" href="https://findaharp-staging.take2tech.ca?findpath=activateemail&email=${emailEncode}"> Confirm Email</a></p>
